...
AS $$
DECLARE
  project_url TEXT := 'https://pugndjkvdbhjdocdylkk.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InB1Z25kamt2ZGJoamRvY2R5bGtrIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyMTIwMjA4NiwiZXhwIjoyMDM2Nzc4MDg2fQ.F__LT1DBq4oBqJiJcSzITzYuHvd81yRl_gYPe4LZssc'; -- full access needed for http request to storage
